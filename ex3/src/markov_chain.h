...
/**
 * MarkovNodeFrequency struct contains a MarkovNode and it's frequency.
 */
...
/**
 * MarkovNode struct contains a state and a list of states that can follow it.
 */
...
/**
 * MarkovChain struct contains a linked list of MarkovNodes.
 */
...
/**
 * Print the markov_chain's database.
 * @param markov_chain
 */
void print_markov_chain(MarkovChain *markov_chain);

/**
 * Print the frequency list of the given markov_node.
 * @param markov_node
 */
