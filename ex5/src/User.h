...
typedef std::shared_ptr<RecommendationSystem> shared_ptr_reco_system_t;
...
class User
{
 private:
  string _name;
  rank_map _rank_map_user;
  shared_ptr_reco_system_t _ptr_recommendation_system;
 public:
  /**
   * Constructor for the class
   */
  User (const string &name, const rank_map &rank_movie,
        shared_ptr_reco_system_t &shared_ptr_reco_sys);
